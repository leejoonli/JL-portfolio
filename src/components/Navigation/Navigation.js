...
import jlee from './file/jeremiahlee.pdf';
                ...
                {showNav && (
                    <>
                        <ul className={styles.navMenu}>
                            ...
                            <a href={jlee} download='Jeremiah_Lee_Software_Engineer' target='_blank' rel='noreferrer' className={styles.aTagNav}><li className={styles.resumeLink}>Resume</li></a>
