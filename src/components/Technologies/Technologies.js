    ...
    return (
        <div className={styles.techContainer} id='skills'>
            ...
            <div className={styles.languages}>
                ...
                <div className={styles.iconContainer}>
                    <img src={c} alt="C Icon" className={styles.techIcons} data-aos='zoom-in' data-aos-once='true' />
                    <h2 className={styles.techHeader}>C</h2>
                </div>
                <div className={styles.iconContainer}>
                    <img src={cpp} alt="C++ Icon" className={styles.techIcons} data-aos='zoom-in' data-aos-once='true' />
                    <h2 className={styles.techHeader}>C++</h2>
                </div>
                <div className={styles.iconContainer}>
            ...
            <div className={styles.frameworks}>
                ...
                <div className={styles.iconContainer}>
                    <img src={postgresql} alt="PostgreSQL Icon" className={styles.techIcons} data-aos='zoom-in' data-aos-once='true' />
                    <h2 className={styles.techHeader}>PostgreSQL</h2>
                </div>
                <div className={styles.iconContainer}>
